...
public class ArchiveExtractTestUtil {

    private final static int MAX_RANDOM = 10;
    private final static int MAX_WAIT_TIME = 20;
    private final static String PROJECT_NAME = "archive-extract";
    ...
    public int createProcess(List<String> a, Object[] e, String o, String j, String c, Path p, Path l)
        ...
        final int waitTime = MAX_WAIT_TIME;
     ...
     *          than or equal to 0) MAX_RANDOM is used
     * @return the generated String
     */
    public static String generateRandomString(int c) {
        byte[] array = new byte[c <= 0 ? MAX_RANDOM : c];
    ...
    public String getShadedJarName() throws IOException {
        ...
        return PROJECT_NAME.concat("-").concat(properties.getProperty("shaded.jar.version")).concat(".jar");
    }
}
